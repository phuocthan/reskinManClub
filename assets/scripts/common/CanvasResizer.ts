...
export default class CanvasResizer extends cc.Component {
    ...
    updateCanvas() {
        ...
        if (this.lastWitdh !== frameSize.width || this.lastHeight !== frameSize.height) {
            ...
            cc.log("frameSize.width", frameSize.width);
            cc.log("frameSize.height", frameSize.height);
            cc.log("this.designResolution.width / this.designResolution.height", this.designResolution.width / this.designResolution.height);
            cc.log("frameSize.width / frameSize.height", frameSize.width / frameSize.height);
