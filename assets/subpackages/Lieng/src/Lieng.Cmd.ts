...
export namespace cmd {
    ...
    export class CmdSendLatBai extends OutPacket {
        ...
        constructor(data: Uint8Array) {
            ...
            for (a = 0; a < Code.MAX_PLAYER; a++) {
                ...
                if (this.hasInfoList[a]) {
                    for (var b = this.getShort(),
                        d = 0; d < b; d++) c.push(this.getByte());
                    b = this.getByte()
                } else b = 0;
    ...
    export class ReceivedLatBai extends InPacket {
        chair: number;
        cardSize: number;
        cards: any[];
        constructor(data: Uint8Array) {
